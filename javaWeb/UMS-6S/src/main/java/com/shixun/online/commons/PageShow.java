...
public class PageShow {
    ...
    public PageShow(int pageNow, int totalPage) {
        super();
    ...
    // 可动态改变每页条数
    public PageShow(int pageNow, int totalSize, int pageSize) {
        super();
        this.pageNow = pageNow;
    ...
    public String toString() {
        return "PageShow [pageNow=" + pageNow + ", totalSize=" + totalSize + ", totalPage=" + totalPage + ", pageSize=" + pageSize + ", hasPre=" + hasPre + ", hasNext=" + hasNext + ", hasFirst=" + hasFirst + ", hasLast=" + hasLast + "]";
    }
